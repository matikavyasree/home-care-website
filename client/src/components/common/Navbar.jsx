        ...
        <div className="hidden lg:flex items-center gap-10">
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `relative text-xl font-semibold transition-all duration-300 after:absolute after:left-0 after:-bottom-1 after:h-[3px] after:bg-[#E11D2E] after:transition-all after:duration-300 ${
                  isActive
        ...
        <div className="bg-white border-t shadow-lg">
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                `block px-6 py-4 text-lg transition-all duration-300 ${
                  isActive
